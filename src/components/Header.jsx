...
const Header = () =>
    <div className="flex flex-row py-1 px-2 bg-gray-100 shadow">
        ...
        <a className="py-2 px-4 flex items-center rounded-lg text-sm sm:text-lg font-bold hover:bg-gray-200 text-gray-700 hover:text-blue-600" href="https://parabible.com">
            Try parabible.com
        </a>
    </div>
