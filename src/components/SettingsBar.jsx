...
const SettingsBar = ({ transformationType, setTransformationType, handleQametzQatan, setHandleQametzQatan }) =>
    <div className="flex flex-row p-2 rounded-t border-b-2 border-gray-200">
        {/* pillbox */}
        <button
        ...
        {/* pointing options */}
        <div className="px-2 py-1 flex flex-col justify-center" style={{ opacity: transformationType === TransformationTypes.TRANSLITERATE ? 1 : 0 }}>
            <ToggleButton
